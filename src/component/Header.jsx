...
function Header() {
  ...
  return (
    <header
      className="w-full bg-cover bg-left-top h-[12vh] p-5 shadow-lg flex items-center justify-between"
    ...
    >
      ...
      <nav className="flex items-center space-x-4">
        ...
        <button onClick={handleLogout} className="px-3 py-1 border border-black flex">
